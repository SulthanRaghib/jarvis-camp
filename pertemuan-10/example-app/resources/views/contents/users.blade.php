                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div
                            ...
                            <a href={{ route('users.create') }} class="btn btn-primary btn-sm me-3">Add User</a>
                        </div>
                        @if (session()->has('success'))
                            <div class="alert alert-success mt-2 fade show" role="alert">
                                {{ session()->get('success') }}
                            </div>
                        @endif
                    </div>
                                    ...
                                    @foreach ($users as $u)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                {{-- <p class="text-xs text-secondary mb-0">zzz</p> --}}
                                            </td>
                                ...
                                <tbody>
                                    @foreach ($posts as $p)
                                        <tr>
                                            ...
                                            <td>
                                                <p class="text-xs font-weight-bold mb-0">{{ $p->author }}</p>
                                                {{-- <p class="text-xs text-secondary mb-0">zzz</p> --}}
                                            </td>
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="d-flex px-2">
                                                <div>
                                                    <img src={{ url('/assets/img/small-logos/logo-asana.svg') }}
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex px-2">
                                                <div>
                                                    <img src={{ url('/assets/img/small-logos/github.svg') }}
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex px-2">
                                                <div>
                                                    <img src={{ url('/assets/img/small-logos/bootstrap.svg') }}
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex px-2">
                                                <div>
                                                    <img src={{ url('/assets/img/small-logos/devto.svg') }}
